...
const localEvents: LocalEvent[] = [
  ...
  },
  {
    ...
    dateLabel: "Dia 08",
    description:
      "Noite comunitaria com venda antecipada, retirada no local e comunicacao direta da paroquia. O evento entra no feed privado por ser uma divulgacao organizada por entidade local.",
    host: "Paroquia Nossa Senhora",
    id: "evt-006",
    location: "Salao paroquial",
    slug: "noite-do-pastel",
    status: "Aberto",
    summary: "Pastel beneficente na paroquia com retirada organizada por horario.",
    tags: ["Privado", "Religioso", "Hoje"],
    timeLabel: "18:30",
    title: "Noite do Pastel",
    visibility: "private",
  },
  {
    category: "Festa privada",
    city: "Frutal, MG",
    ctaLabel: "Confirmar presenca",
    dateLabel: "Sabado, 03 Ago",
    description:
      "Festa com limite de convidados, comidas, bebidas e musica. A experiencia cobre convites privados, lista controlada e contato com o organizador sem expor dados sensiveis no feed.",
    host: "Tira Eventos",
    id: "evt-007",
    location: "Espaco Lago Azul",
    slug: "festa-aniversario-do-tira",
    status: "Convites ativos",
    summary: "Comidas, bebidas e musica para convidados confirmados.",
    tags: ["Privado", "Aniversario", "Musica ao vivo"],
    timeLabel: "21:00",
    title: "Festa de Aniversario do Tira",
    visibility: "private",
  },
  {
    category: "Promocao comercial",
    city: "Frutal, MG",
    ctaLabel: "Ver promocao",
    dateLabel: "Sexta, 02 Ago",
    description:
      "Aniversario comercial com promocao de pratos selecionados, reserva de mesas e controle de procura. O card prepara patrocinio, engajamento e notificacao para eventos de empresas.",
    host: "Restaurante Casarao",
    id: "evt-008",
    location: "Av. Brasil, 1020",
    slug: "aniversario-restaurante-casarao",
    status: "Publicado",
    summary: "Tudo pela metade do preco nesta sexta com reserva limitada.",
    tags: ["Privado", "Promocao", "Final de semana"],
    timeLabel: "19:00",
    title: "Aniversario do Restaurante Casarao",
    visibility: "private",
  },
];
